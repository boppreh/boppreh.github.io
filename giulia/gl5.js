...
/**
 * Registers a new behavior to be called every frame with each combination of
 * entities from the given tags. Returns the created 'behavior' function.
 * layer.register('enemy', 'bullet', checkCollision);
 */
Layer.prototype.register = function (/*tag1, tag2, tag3, func*/) {
    var args = Array.prototype.slice.call(arguments, 0),
        func = args.slice(-1)[0],
        tags = args.slice(0, -1),
        id = ++this.behaviorCount,
        self = this;

    var behavior = function () {
        self.forEach.apply(self.forEach, args);
    }
